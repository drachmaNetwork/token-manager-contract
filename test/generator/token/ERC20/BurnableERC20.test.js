...
contract('BurnableERC20', function ([owner, other, thirdParty]) {
  ...
  beforeEach(async function () {
    ...
    await receiver.setPrice('BurnableERC20', fee)
  })
    ...
    describe('as a BurnableERC20', function () {
      describe('without initial supply', function () {
        it('should fail', async function () {
          await expectRevert(
            BurnableERC20.new(_name, _symbol, _decimals, 0, receiver.address, {
              from: owner,
              value: fee
            }),
      ...
      describe('with initial supply', function () {
        beforeEach(async function () {
          this.token = await BurnableERC20.new(_name, _symbol, _decimals, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          })
        })
