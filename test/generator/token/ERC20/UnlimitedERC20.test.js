...
contract('UnlimitedERC20', function ([owner, other, thirdParty]) {
  ...
  beforeEach(async function () {
    ...
    await receiver.setPrice('UnlimitedERC20', fee)
  })
  ...
  context('creating valid token', function () {
    describe('as a UnlimitedERC20', function () {
      describe('without initial supply', function () {
        beforeEach(async function () {
          this.token = await UnlimitedERC20.new(_name, _symbol, _decimals, 0, receiver.address, {
            from: owner,
            value: fee
          })
        })
      ...
      describe('with initial supply', function () {
        beforeEach(async function () {
          this.token = await UnlimitedERC20.new(_name, _symbol, _decimals, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          })
        })
