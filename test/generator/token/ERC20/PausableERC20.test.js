...
contract('PausableERC20', function ([owner, other, thirdParty]) {
  ...
  beforeEach(async function () {
    ...
    await receiver.setPrice('PausableERC20', fee)
  })
    ...
    describe('as a PausableERC20', function () {
      describe('without initial supply', function () {
        it('should fail', async function () {
          await expectRevert(
            PausableERC20.new(_name, _symbol, _decimals, 0, receiver.address, {
              from: owner,
              value: fee
            }),
      ...
      describe('with initial supply', function () {
        beforeEach(async function () {
          this.token = await PausableERC20.new(_name, _symbol, _decimals, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          })
        })
