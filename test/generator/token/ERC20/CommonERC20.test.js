...
contract('CommonERC20', function ([owner, other, thirdParty]) {
  ...
  beforeEach(async function () {
    ...
    await receiver.setPrice('CommonERC20', fee)
  })
  ...
  context('creating valid token', function () {
    describe('as a ERC20Capped', function () {
      it('requires a non-zero cap', async function () {
        await expectRevert(
          CommonERC20.new(_name, _symbol, _decimals, 0, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          }),
    ...
    describe('as a CommonERC20', function () {
      describe('without initial supply', function () {
        beforeEach(async function () {
          this.token = await CommonERC20.new(_name, _symbol, _decimals, _cap, 0, receiver.address, {
            from: owner,
            value: fee
          })
        })
      ...
      describe('with initial supply', function () {
        beforeEach(async function () {
          this.token = await CommonERC20.new(_name, _symbol, _decimals, _cap, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          })
        })
