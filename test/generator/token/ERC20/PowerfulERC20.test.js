...
contract('PowerfulERC20', function ([owner, other, thirdParty]) {
  ...
  beforeEach(async function () {
    ...
    await receiver.setPrice('PowerfulERC20', fee)
  })
  ...
  context('creating valid token', function () {
    describe('as a ERC20Capped', function () {
      it('requires a non-zero cap', async function () {
        await expectRevert(
          PowerfulERC20.new(_name, _symbol, _decimals, 0, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          }),
    ...
    describe('as a PowerfulERC20', function () {
      describe('without initial supply', function () {
        beforeEach(async function () {
          this.token = await PowerfulERC20.new(_name, _symbol, _decimals, _cap, 0, receiver.address, {
            from: owner,
            value: fee
          })
        })
    ...
    describe('with initial supply', function () {
      beforeEach(async function () {
        this.token = await PowerfulERC20.new(_name, _symbol, _decimals, _cap, _initialSupply, receiver.address, {
          from: owner,
          value: fee
        })
      })
