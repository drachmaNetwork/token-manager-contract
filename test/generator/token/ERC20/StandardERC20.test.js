...
contract('StandardERC20', function ([owner, other, thirdParty]) {
  ...
  beforeEach(async function () {
    ...
    await receiver.setPrice('StandardERC20', fee)
  })
    ...
    describe('as a StandardERC20', function () {
      describe('without initial supply', function () {
        it('should fail', async function () {
          await expectRevert(
            StandardERC20.new(_name, _symbol, _decimals, 0, receiver.address, {
              from: owner,
              value: fee
            }),
      ...
      describe('with initial supply', function () {
        beforeEach(async function () {
          this.token = await StandardERC20.new(_name, _symbol, _decimals, _initialSupply, receiver.address, {
            from: owner,
            value: fee
          })
        })
